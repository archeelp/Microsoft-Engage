...
router.route("/schedule")
  .get(studentScheduleHandler.getSchedule);

router.route("/course")
  .get(studentCourseHandler.getCourses);

router.route("/course/:courseId")
  .post(middlewares.checkStudentNotEnrolledInCourse, studentCourseHandler.enrollCourse)
  .get(middlewares.checkStudentEnrolledInCourse, courseHandler.getCourse)
  .delete(middlewares.checkStudentEnrolledInCourse, studentCourseHandler.unenrollCourse);

router.route("/course/:courseId/lecture/:lectureId")
